  ...
  Widget build(BuildContext context) {
    return PopupMenuButton<DeviceInfo>(
      ...
      itemBuilder: (_) => [
        ...
        _buildSeparator('macOS'),
        ..._buildItems(Devices.macOS.all),
        _buildSeparator('Windows'),
        ..._buildItems(Devices.windows.all),
        _buildSeparator('Linux'),
        ..._buildItems(Devices.linux.all),
      ],
